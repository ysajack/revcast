...
<div class="wrapper" >
	...
	<section>
	<h3 style="text-align:center;">Adding and allocating an associate is successful!</h3>
	</section>
	 ...
	 <% String associateId = request.getParameter("associateId");
		...
		int rate = Integer.parseInt(request.getParameter("rateCard"));
		String projectId = request.getParameter("projectId"); %>
		
<table id="allocate-success">
	  <tr>
	  	<th>
	  		Associate ID
	  	</th>
