...
<div id="tbldiv" class="container">
	...
	<form action="/addAssociate" method="post">
			<table id="addAssociate">
				...
				<tr>
					<td><input type="text" name="associateId" required/></td>
					<td><input type="text" name="associateName" required/></td>
					<td><input type="text" name="designation" required/></td>
					<td><input type="text" name="status" required/></td>
					<td><input type="text" name="revCat" required/></td>
					<td><input type="text" name="practice" required/></td>
					<td><input type="text" name="onsiteOffshore" required/></td>
				</tr>
				
			</table>
			<input type="submit" value="Submit" class="button"/> <!-- <input type="submit" value="Next" class="button"/> -->
