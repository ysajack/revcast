...
public class GCPConnection {
	/*
	private static final String CLOUD_SQL_CONNECTION_NAME = "revcast-rest:us-west1:revcast";//System.getenv("CLOUD_SQL_CONNECTION_NAME");
	private static final String DB_USER = "root";//System.getenv("root");
	private static final String DB_PASS = "revcast";//System.getenv("revcastpw");
	private static final String DB_NAME = "revcast";//System.getenv("rs2u-eb426:us-west1:revcast-db");
	...
	public DataSource createConnectionPool() {
		...
		String url = "jdbc:mysql://google/"+DB_NAME+"?cloudSqlInstance="+CLOUD_SQL_CONNECTION_NAME+"&socketFactory=com.google.cloud.sql.mysql.SocketFactory&useSSL=false";
	...
	private Connection getConnectionToGCSQL(){
	String CLOUD_SQL_CONNECTION_NAME = "revcast-rest:us-west1:revcast";
		String username = "root";
		String password = "revcast";
		String DB_NAME = "revcast";
		Class.forName("com.mysql.jdbc.Driver");
		String url = "jdbc:mysql://google/"+DB_NAME+"?cloudSqlInstance="+CLOUD_SQL_CONNECTION_NAME+"&socketFactory=com.google.cloud.sql.mysql.SocketFactory&useSSL=false&user="+username+"&password="+password;
