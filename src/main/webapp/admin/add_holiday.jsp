...
<%@ page import="com.cognizant.revcast.servlets.UtilityServlet" %>
...
<div class="wrapper" >
	...
	<p>Please enter the info below to add holidays</p>
	<div id="leave-entry">
	<fieldset>
	<form action="/addHoliday" method="post">
			<table style="with: 50%">
				<tr>
					<td>Year</td>
					<td>
					<%int currentYear = Integer.parseInt(UtilityServlet.getCurrentYear());%>
						<select name="year">
				...
				<tr>
					...
					<td>
						<input type="number" name="num_of_days" value="1" min="1" max="3" onchange="checkNumOfDays(this.value)" required/>
					</td>
				</tr>
				<tr>
					<td>Holiday Date(s)</td>
					<td>
