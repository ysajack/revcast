...
<div class="wrapper" >
	...
	<h3 style="text-align:center">Your request failed! Please try again!</h3>
	<h3 style="text-align:center">If the issues persist, please contact Admin or your Manager!</h3>
